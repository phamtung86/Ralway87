...
public class Program {
	...
	public static boolean checkLogin (String userName, String passWord) {
		for (int i = 0; i < listAccounts.size(); i++) {
			if(listAccounts.get(i).getUserName().equals(userName) && listAccounts.get(i).getPassWord().equals(passWord)) {
				return true;
			}
		}
		return false;
	...
	public static void createAccount () {
		...
		Account acc = new Account(String.valueOf(AccountUtils.generateIdAccount(listAccounts)), userName, passWord, user);
		listUsers.add(user);
		...
		if(checkLogin(userName, passWord)) {
			...
			do {
				...
				case 1: {
					...
					Bet bet = new Bet(String.valueOf(BetUltils.generateIdBet(listBets)), type, numberBet, priceBet);
					listBets.add(bet);
					UserBet userBet = new UserBet(String.valueOf(UserBetUtils.generateIdUser(listUserBets)),AccountUtils.getAccFromID(userName, listAccounts),bet);
...
//		displayResultSpin("Đặc biệt", listSpecialPrize);
		LotertResult lotertResult = new LotertResult(listSpecialPrize, listFristPrize, listSecondPrize, listThirdthPrize, listFourthPrize, listFifthPrize, listSixthPrize, listSeventhPrize);
	...
	public static String findID () {
		for (int i = 0; i < listUserBets.size(); i++) {
			if(listBets.get(i).getNumberBet().equals(listLoteryResult.getLast().getListSpecialPrize().toString().substring(4,6))) {
				return listBets.get(i).getId().toString();
			}
		}
		return null;
	}
	...
	public static void listDe () {
		...
		for (int i = 0; i < listUserBets.size(); i++) {
			if(listUserBets.get(i).getBet().getId().equals(findID())) {
	...
	public static void fakeData () {
        ...
        listBets.add(new Bet("1", "Đề", "73", 100.0));
        listBets.add(new Bet("2", "Lô", "234", 200.0));
        listBets.add(new Bet("3", "Lô", "345", 150.0));
        listBets.add(new Bet("4", "Đề", "56", 120.0));
        listBets.add(new Bet("5", "Lô", "567", 300.0));
        listBets.add(new Bet("6", "Đề", "68", 80.0));
        listBets.add(new Bet("7", "Đề", "78", 220.0));
        listBets.add(new Bet("8", "Đề", "90", 190.0));
        listBets.add(new Bet("9", "Lô", "901", 210.0));
        listBets.add(new Bet("10", "Lô", "012", 130.0));
        listBets.add(new Bet("11", "Đề", "11", 140.0));
        listBets.add(new Bet("12", "Lô", "223", 170.0));
        listBets.add(new Bet("13", "Lô", "334", 160.0));
        listBets.add(new Bet("14", "Đề", "45", 180.0));
        listBets.add(new Bet("15", "Lô", "456", 250.0));
        listBets.add(new Bet("16", "Đề", "67", 100.0));
        listBets.add(new Bet("17", "Đề", "89", 240.0));
        listBets.add(new Bet("18", "Đề", "91", 200.0));
        listBets.add(new Bet("19", "Lô", "123", 220.0));
        listBets.add(new Bet("20", "Lô", "234", 150.0));
        listBets.add(new Bet("21", "Đề", "13", 190.0));
        listBets.add(new Bet("22", "Lô", "345", 300.0));
        listBets.add(new Bet("23", "Lô", "456", 170.0));
        listBets.add(new Bet("24", "Đề", "79", 210.0));
        listBets.add(new Bet("25", "Lô", "567", 260.0));
        listBets.add(new Bet("26", "Đề", "80", 110.0));
        listBets.add(new Bet("27", "Đề", "92", 230.0));
        listBets.add(new Bet("28", "Đề", "94", 180.0));
        listBets.add(new Bet("29", "Lô", "678", 200.0));
        listBets.add(new Bet("30", "Lô", "789", 150.0));
	...
	public static void menuOptionLogin () {
		...
		} while (selectValue > 0 && selectValue < 5);
	}
